...
public class YoutubeService {
     ...
     * @throws IOException
     */
    public List<YouTubeItemDto> youTubeSearch(String channelId, Youtube recommend) throws MamException {
        ...
        if (youtube != null) {
            ...
            try {
                ...
                rvalue = searchResultList.stream().map(
                        value -> YouTubeItemDto.builder()
                                .url("https://www.youtube.com/watch?v=" + value.getId().getVideoId())
                                .title(value.getSnippet().getTitle())
                                .description(value.getSnippet().getDescription())
                                .videoId(value.getId().getVideoId())
                                .playListId(value.getId().getPlaylistId())
